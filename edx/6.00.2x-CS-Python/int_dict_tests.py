...
# If our hash table has 1000 buckets and we perform 50 insertions, 
# what is the calculated probability of a collision?
print '1 |', collision_prob(1000, 50)

# If our hash table has 1000 buckets and we perform 200 insertions, 
# what is the calculated probability of a collision?
print '2 |', collision_prob(1000, 200)

# If our hash table has 1000 buckets and we perform 50 insertions, 
# perform a simulation to observe the probability of a collision. Run for at least 1000 trials;
print '3 |', observe_prob(1000, 50, 1000)

# If our hash table has 1000 buckets and we perform 200 insertions, 
# perform a simulation to observe the probability of a collision. Run for at least 1000 trials;
print '4 |', observe_prob(1000, 200, 1000)

# Say you're in a classroom with 29 other students (30 total students). 
# What is the calculated probability that two students share the same birthdate? 
# For simplicity, assume there are 365 days in a year and all birthdates are equally probable.
print '5 |', collision_prob(365, 30)

# Say you're in a lecture hall with 249 other students (250 total students). 
# What is the calculated probability that two students share the same birthdate? 
# For simplicity, assume there are 365 days in a year and all birthdates are equally probable.
print '6 |', collision_prob(365, 250)
